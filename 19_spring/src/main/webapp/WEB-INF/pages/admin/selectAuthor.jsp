    ...
    function select(table_Id, click_Class, form) {
        ...
        if (click_Class) table.onclick = function (e) {
            ...
            if (elem.parentNode.tagName == 'TR' &&
                ...
                form.elements.authorId.value = row.cells[0].innerHTML;
                form.submit();
            }
        };
    }
...
<form id="selectAuthorForm" action="/admin/createBook" method="get">
    <input type="hidden" name="authorId">
    <script type="text/javascript">
        select("authors", "clicked_Row", document.getElementById("selectAuthorForm"));
    </script>
</form>
